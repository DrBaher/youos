...
A live draft demo over baher@work.example over-kept transactional mail (a
...
GENUINE_SAMPLES = [
    ...
    (
        ...
        _msg(
            "Fadi Saleh <fadi@work.example>", "fadi@work.example",
            "Quick sync tomorrow?",
    ...
    (
        ...
        _msg(
            "Maria HR <maria@work.example>", "maria@work.example",
            "Payroll arrangement",
    ...
    (
        "colleague_request",
        _msg(
            "Omar <omar@work.example>", "omar@work.example",
            "Slides for Thursday",
...
class TestSpecificGaps:
    ...
    def test_personal_mailbox_not_penalised(self):
        ...
        for addr in ("fadi@work.example", "sarah@clientcorp.com", "omar@work.example"):
...
class TestDemoUsesProductionClassifier:
    ...
    def test_demo_decide_keeps_genuine_mail(self):
        ...
        payload = {
            "headers": [
                {"name": "From", "value": "Fadi Saleh <fadi@work.example>"},
                {"name": "Subject", "value": "Quick sync tomorrow?"},
            ]
        }
        verdict = demo.decide(
            payload,
            sender="Fadi Saleh <fadi@work.example>",
