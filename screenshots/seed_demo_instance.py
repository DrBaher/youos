...
shutil.copy("/Users/bbot/YouOS/docs/schema.sql", DEMO / "docs" / "schema.sql")

os.environ["YOUOS_DATA_DIR"] = str(DEMO)

# --- config: synthetic identity, local model, no PIN ---
import yaml  # noqa: E402
repo_cfg = yaml.safe_load(Path("/Users/bbot/YouOS/youos_config.yaml").read_text())
...
for f in ("persona.yaml", "retrieval.yaml", "prompts.yaml", "autoresearch.yaml"):
    src = Path("/Users/bbot/YouOS/configs") / f
    if src.exists():
